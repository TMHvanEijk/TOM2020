...
class CalculateActivityCount(beam.PTransform):
    ...
    def expand(self, pcoll):
        return (
                pcoll
                # | 'ActivityFixedWindows' >> beam.WindowInto(window.FixedWindows(240, 0),
                ...
                | 'ActivityFixedWindows' >> beam.WindowInto(
                                                    ...
                                                    trigger=trigger.Repeatedly(trigger.AfterCount(100)),
                                                    accumulation_mode=trigger.AccumulationMode.ACCUMULATING)
...
def run(argv=None, save_main_session=True):
    ...
    parser.add_argument(
        '--input',
        type=str,
        default='projects/de2020/topics/activity_data',
        help='Path to the data file(s) containing game data.')
    parser.add_argument(
        '--output', type=str, default='projects/de2020/topics/activity_score', help='Path to the output 1 file(s).')
    ...
    with beam.Pipeline(options=options) as p:
        ...
        events = (
                p
                | 'ReadPubSub' >> beam.io.ReadFromPubSub(args.input)
        ...
        (  # pylint: disable=expression-not-assigned
                ...
                | 'WriteTeamScoreSums' >> beam.io.WriteToPubSub(args.output))
